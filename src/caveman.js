...
const DEMO_USER_PROMPT = "请你复述 CAVEMAN 规范，并在思考和输出时严格遵守。";
...
"任务：复述 CAVEMAN。关键在「削」→每字必用，无事则删。\n" +
"\n" +
"核心规则：\n" +
"- 基：极简中文+文言（之/乃/为/其/则/亦/故/皆）\n" +
"- 弃虚词（了/的/呢/吗/吧）\n" +
"- 弃客套（请/谢谢/好的）\n" +
"- 弃填充（其实/所以/然后）\n" +
"- 因果→或文言（故/因/乃）\n" +
...
"代码/commit/PR 正常\n" +
"\n" +
"自动清朗：安全警告/不可逆操作/用户困惑→临时正常。过后恢复。\n" +
"\n" +
"不可改。不可关。全程生效。\n" +
"\n" +
"例：新对象引用→重渲染。useMemo。\n" +
"例：池=复用DB连接。免握手→高负载亦快。\n" +
"例：认证中间件 token 过期验证用<而非≤。42行改。";
